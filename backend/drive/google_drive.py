"""
DEPRECATED: Google Drive client for course data storage.

This module is deprecated as course data has been migrated to Firestore.
It is kept only for reference purposes.

The active codebase no longer uses Google Drive for course data storage.
All course data operations should use firestore.course_data instead.
"""
